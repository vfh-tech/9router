...
llm = ChatOpenAI(
    ...
    openai_api_base="http://localhost:2222/v1",
    temperature=0.7
)
...
llm = OpenAI(
    model="cc/claude-sonnet-4-20250514",
    api_key="your-api-key-from-dashboard",
    api_base="http://localhost:2222/v1"
)
...
openai.api_base = "http://localhost:2222/v1"
...
ROUTER_BASE_URL=http://localhost:2222/v1
...
- Verifica que el puerto 2222 no esté bloqueado
...
- Verifica los modelos disponibles: `curl http://localhost:2222/v1/models`
